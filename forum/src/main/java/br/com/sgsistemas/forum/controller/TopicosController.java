...
import br.com.sgsistemas.forum.controller.dto.DetalhesDoTopicoDto;
import br.com.sgsistemas.forum.controller.dto.TopicoDto;
import br.com.sgsistemas.forum.controller.form.AtualizacaoTopicoForm;
...
public class TopicosController {
	...
	public Page<TopicoDto> lista(@RequestParam(required = false)String nomeCurso, @PageableDefault(sort = "id", direction = Sort.Direction.ASC, page = 0, size = 10) Pageable pageable) {
		if (nomeCurso == null) {
