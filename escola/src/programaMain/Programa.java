...
public class Programa {
    public static void main(String[] args) {
        ...
        Turma turma1 = new Turma(escola1,"A-5");

        Endereco enderecoAluno1 = new Endereco("Maringa", "Rua 101", "1213");
        Aluno aluno1 = new Aluno("Aleph", "060.660.006-33",enderecoAluno1);
        Endereco enderecoAluno5 = new Endereco("Maringa", "Rua 101", "1213");
        Aluno aluno5 = new Aluno("Aleph", "060.660.006-33",enderecoAluno1);
        ...
        System.out.println(turma1.toString()); // info turma

        turma1.alunoInfo("120.320.564-22"); // info turma aluno
